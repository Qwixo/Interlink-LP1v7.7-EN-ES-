              ...
              <div className="mb-8">
                ...
                <ul className="space-y-2 text-gray-700">
                  <li className="flex items-start">
                    ...
                    <span className="ml-2">Estudiantes que quieren <span className="font-semibold">sumergirse completamente</span> en la vida universitaria estadounidense</span>
                  </li>
                  <li className="flex items-start">
                    <Check className="w-5 h-5 text-green-500 mt-0.5 flex-shrink-0" />
                    <span className="ml-2">Aquellos que planean ingresar a una <span className="font-semibold">universidad de EE. UU.</span></span>
                  </li>
                  <li className="flex items-start">
                    <Check className="w-5 h-5 text-green-500 mt-0.5 flex-shrink-0" />
                    <span className="ml-2">Estudiantes que aprenden mejor con <span className="font-semibold">interacciones presenciales</span></span>
                  </li>
                </ul>
              </div>
            ...
            <div className="p-8">
              ...
              <div className="mb-8">
                ...
                <ul className="space-y-2 text-gray-700">
                  <li className="flex items-start">
                    <Check className="w-5 h-5 text-green-500 mt-0.5 flex-shrink-0" />
                    <span className="ml-2">Estudiantes que necesitan un horario <span className="font-semibold">flexible</span> y prefieren estudiar desde casa</span>
                  </li>
                  <li className="flex items-start">
                    <Check className="w-5 h-5 text-green-500 mt-0.5 flex-shrink-0" />
                    <span className="ml-2">Quienes quieren <span className="font-semibold">prepararse para estudiar en EE. UU.</span> antes de mudarse</span>
                  </li>
                  <li className="flex items-start">
                    <Check className="w-5 h-5 text-green-500 mt-0.5 flex-shrink-0" />
                    <span className="ml-2">Profesionales ocupados que prefieren mejorar su inglés sin viajar</span>
                  </li>
                </ul>
              </div>
